...
void Background::drawSky(int winWidth, int winHeight){
	...
	glBegin(GL_QUADS);
		glTexCoord2f(0.0,0.0); glVertex2i(-15,0);
		glTexCoord2f(0.0,1.0); glVertex2i(-15,15);
		glTexCoord2f(1.0,1.0); glVertex2i(15, 15);
		glTexCoord2f(1.0,0.0); glVertex2i(15, 0);
	glEnd();
...
void Background::drawGround(int winWidth, int winHeight){
	...
	glBegin(GL_QUADS);
		...
		glTexCoord2i(0,1); glVertex2i(-15,0);
		glTexCoord2i(1,1); glVertex2i(15, 0);
